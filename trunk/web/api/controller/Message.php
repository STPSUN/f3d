...
class Message extends \web\api\controller\ApiBase{
    ...
    public function notice(){
        ...
        foreach($rows as &$val){
            $val['content'] = preg_replace("/\/ueditor\//","http://cgcc.ifc007.com/ueditor/",$val['content']);
        }
    ...
    public function FeedbackFid(){
        ...
        $info['back_content'] = preg_replace("/\/ueditor\//","http://cgcc.ifc007.com/ueditor/",$info['back_content']);
