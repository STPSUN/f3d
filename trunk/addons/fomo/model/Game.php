...
class Game extends \web\common\model\BaseModel{
    ...
    public function getRunGame($fields='id,status,coin_id,coin_name,winner_rate,team_rate,fund_rate,total_buy_seconds,total_amount,pool_total_amount,release_total_amount,end_game_time'){
        $m = new \addons\config\model\Coins();
