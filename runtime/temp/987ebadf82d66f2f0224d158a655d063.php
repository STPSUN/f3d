<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/luckywinner.vip/public/../addons/fomo/user/view/default/remark/edit.html";i:1536304143;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
...
<div class="box-content">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="title" class="form-control required" style="width:300px" />
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <select name="type" id="type" style="width:160px" class="form-control">
                <option value="0">空投说明</option>
                <option value="1">战队说明</option>
                <option value="2">游戏说明</option>
                <option value="3">令牌说明</option>
            </select>
        </div>
    </div>
    <div class="control-group">
