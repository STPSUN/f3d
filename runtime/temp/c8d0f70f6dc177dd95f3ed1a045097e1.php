<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/luckywinner.vip/public/../addons/member/user/view/default/suggest/edit.html";i:1539077860;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
...
<div class="box-content">   
    ...
    <div class="control-group">
        <label class="control-label">反馈用户</label>
        <div class="controls">
            <input type="text" id="user_name" readonly name="user_id" class="form-control" />
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">反馈标题</label>
        <div class="controls">
            <input type="text" id="title" name="title" readonly class="form-control" />
            </div>
    </div>
    <div class="control-group">
        <label class="control-label">反馈内容</label>
        <div class="controls">
            <textarea style="width:400px;height:300px" readonly name="content"  id="content"  class="textarea" ></textarea>
        </div>
    </div>
<!--    <div class="control-group">
        <label class="control-label">反馈图片</label>
        <div class="controls">
            <img src="<?php echo $pic; ?>" alt="反馈图片" style="width:400px;height:300px;">
        </div>
    </div>-->

<!--    <div class="control-group">
        <label class="control-label">反馈回复</label>
        <div class="controls">
            <script id="container" name="back_content" type="text/plain"><?php echo $back_content; ?></script>
            <textarea style="width:400px;height:300px" name="content" id="content" placeholder="请输入内容" class="textarea" ></textarea>                                 
        </div>
    </div>-->
</div>
<!-- 配置文件 -->
