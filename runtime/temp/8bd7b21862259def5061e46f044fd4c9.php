<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/luckywinner.vip/public/../addons/fomo/user/view/default/token_rule/index.html";i:1535992913;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <?php if(is_array($param_list) || $param_list instanceof \think\Collection || $param_list instanceof \think\Paginator): $i = 0; $__LIST__ = $param_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['control_type'] == 'select'): ?>
            <div class="control-group">
                ...
                <select name="<?php echo $vo['field']; ?>" class="required form-control" style='width:160px'>                
                    <option value="0" <?php if($vo['parameter_val'] == 0): ?>selected<?php endif; ?>>令牌持有者</option>
                    <option value="1" <?php if($vo['parameter_val'] == 1): ?>selected<?php endif; ?>>平台</option>
                </select> 
            </div>
