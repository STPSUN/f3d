<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/luckywinner.vip/public/../addons/fomo/user/view/default/game/edit_total.html";i:1535992907;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <input type="hidden" id="id" name="id" />  
        <div class="control-group">
            <label class="control-label">
                奖池总额</label>
            <div class="controls">
                <input type="text" name="pool_total_amount" id="pool_total_amount" class="form-control required" />
            </div>
        </div>
