<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/luckywinner.vip/public/../addons/config/user/view/default/account/edit.html";i:1535992874;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
...
<div class="box-content">   
    ...
    <div class="control-row col-2">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="username" name="username" placeholder="请使用数字与英文字母组合" class="form-control required" />                                      
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="lxr" name="lxr" class="form-control required" />    
            </div>
        </div>
        <div class="control-group">
