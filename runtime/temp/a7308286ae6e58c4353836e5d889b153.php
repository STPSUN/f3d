<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/luckywinner.vip/public/../addons/config/user/view/default/help/edit.html";i:1535992873;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
...
<div class="box-content">   
    ...
    <div class="control-row col-2">
        <div class="control-group">
            ...
            <div class="controls">
                <input style="width:150px" type="text" id="title" name="title" placeholder="在此输入标题" class="form-control required" />
            </div>
        </div> 
    </div>
    <div class="control-row col-4">
        <div class="control-group">
            <label class="control-label">类型</label>
            <div class="controls">
                <select name="type" id="" class="form-control required">
                    <option value="1">商学院</option>
                    <option value="2">游戏规则</option>
    ...
    <div class="control-group">
        <label class="control-label">新闻资讯内容</label>
        <div class="controls">
            <textarea id="content" name="content"></textarea>
            <?php echo hook('editor', array('height'=>'','id'=>"$id",'name'=>'content')); ?>
        </div>
    </div>
</div>
