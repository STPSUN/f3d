<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"/www/wwwroot/luckywinner.vip/public/../addons/member/user/view/default/member/add_coin_stock.html";i:1535992924;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <div class="box-content"> 
        ...
        <div class="control-group">
            <label class="control-label">选择币种</label>
            <div class="controls">
                <select name="coin_id" id="coin_id" class="form-control required">
                    <?php if(is_array($coins) || $coins instanceof \think\Collection || $coins instanceof \think\Paginator): $i = 0; $__LIST__ = $coins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
