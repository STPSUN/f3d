<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/luckywinner.vip/public/../addons/fomo/user/view/default/team/edit.html";i:1535992911;s:81:"/www/wwwroot/luckywinner.vip/public/../web/user/view/default/base/popup_form.html";i:1535992995;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <div class="control-row col-2">
        ...
        <div class="control-group">
            <label class="control-label">
                奖池比率</label>
            <div class="controls">
                <input type="number" name="pool_rate" id="poll_rate" class="form-control required" />                       
                <span class="tips">%(投注时)</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                f3d分红比率</label>
            <div class="controls">
                <input type="number" name="f3d_rate" id="f3d_rate" class="form-control required" />                       
                <span class="tips">%(投注时)</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                p3d分红比率</label>
            <div class="controls">
                <input type="number" name="p3d_rate" id="p3d_rate" class="form-control" />                       
                <span class="tips">%(投注时)</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                下一局比率</label>
            <div class="controls">
                <input type="number" name="to_next_rate" id="to_next_rate" class="form-control required" />                       
                <span class="tips">%(结束时)</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                f3d分红比率</label>
            <div class="controls">
                <input type="number" name="end_f3d_rate" id="end_f3d_rate" class="form-control required" />                       
                <span class="tips">%(结束时)</span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                p3d分红比率</label>
            <div class="controls">
                <input type="number" name="end_p3d_rate" id="end_p3d_rate" class="form-control" />                       
                <span class="tips">%(结束时)</span>
            </div>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div id="js_upload_wrp">
                ...
                <?php echo hook('picResource',array('name'=>'pic','folder'=>'fomo','tips'=>'建议尺寸：800x600像素。仅支持.jpg .png格式长方形照片。','callback'=>'uploadImgCallback')); ?>
            </div>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <div id="js_upload_wrp">
                <input type="hidden" id="select_pic" name="select_pic" value="" class="" />
                <?php echo hook('picResource',array('name'=>'select_pic','folder'=>'fomo','tips'=>'','callback'=>'uploadSelectImgCallback')); ?>
            </div>
        </div>
    </div>
...
function uploadSelectImgCallback(path) {
    $("#select_pic").val(path);
}

function onLoadDataSuccess(data) {
    setPicValue("pic", data['pic']);
    setPicValue("select_pic", data['select_pic']);
}
